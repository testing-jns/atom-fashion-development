...
<head>
  ...
  <link rel="stylesheet" href="<?= BASE_URL ?>assets/admin/css/add-product.css">
  <link rel="stylesheet" href="<?= BASE_URL ?>assets/admin/css/file-upload.css">
...
<body>
  <div class="container-scroller">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Good Morning, <span class="text-black fw-bold">Lontong, Joko, Pasha</span></h1>
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown"> 
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="countDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                  <img src="<?= BASE_URL ?>assets/admin/images/faces/face1.jpg" alt="image" class="img-sm profile-pic">
                </div>
                <div class="preview-item-content flex-grow py-2">
    ...
    <div class="page-body-wrapper">
      <!-- partial:<?= BASE_URL ?>assets/admin/partials/_settings-panel.html -->
                  ...
                  <div class="form first">
                    <div class="fields">
                      <div class="input-field">
                        <label>Code</label>
                        <input type="text" class="product_code" name="code" value="<?= $product_code ?>" readonly disabled>
                      </div>
            
                      <div class="input-field long-field">
                        <label>Name</label>
                      ...
                      <div class="input-field">
                        ...
                        <select required name="for_gender">
                      ...
                      <div class="input-field">
                        <label>Price</label>
                        <input type="number" name="price" placeholder="Product Price" min="0" required>
                      </div>
                      ...
                      <div class="input-field">
                        <label>Stock</label>
                        <input type="number" name="stock" placeholder="Product Stock" min="0" required>
                      </div>
            
                      <div class="input-field">
                        <label>Sold</label>
                        <input type="number" name="sold" placeholder="Product Sold" min="0" required>
                      </div>
            
                      <div class="input-field">
                        <label>Rating</label>
                        <input type="number" name="rating" min="1" max="5" maxlength="1" placeholder="Product Rating" required>
                      </div>
                      <div class="input-field input-field-form-2">
                        <label>Tags</label>
                        <input type="text" name="tags" multiple placeholder="Product Tags, separated by coma" required>
                      </div>
                    </div>
                    ...
                    <div class="fields">
                      ...
                      <div class="input-field input-field-form-2">
                        <label>
                          ...
                          Thumbnails</label>
                        <div class="temporary-gallery"></div>
                        <div class="drop-area">
                          <!--  name="files[]"  multiple accept="image/*" -->
                          <!-- onchange="handleFiles(this.files)" -->
                          <input type="file" name="files[]" multiple accept="image/*" onchange="handleFiles(this.files)" class="input-files" id="fileElem" required>
                          <label class="button-upload-file" for="fileElem">Select some files or drag and drop</label>
                        </div>
                      </div>
                    </div>
...
<script src="<?= BASE_URL ?>assets/admin/js/add-product.js"></script>
<script src="<?= BASE_URL ?>assets/admin/js/add-submit-product.js"></script>
