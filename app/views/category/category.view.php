...
$category_products = $controll->model("products/CategoryProducts");
$display_products = $controll->model("products/DisplayProducts");

$category_list = $display_products->categoryList();
$all_products = $category_products->execute($view_data["results"]["category"]);
...
<head>
  ...
  <!--
    - custom css link
  -->
  <link rel="stylesheet" href="<?= BASE_URL ?>assets/css/products/style.css">
